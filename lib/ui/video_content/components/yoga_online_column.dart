...
Widget videoLessons(
    isLandscape, videosToDisplay, BuildContext context, favoriteVideosIds) {
  ...
  videosToDisplay.forEach((video) {
    if (!video.isActive) {
      ...
      videosColumn.add(YogaOnlineLessonCard(
          yogaOnlineLesson: video,
          isLandscape: isLandscape,
          favoriteVideosIds: favoriteVideosIds));
    }
  });
